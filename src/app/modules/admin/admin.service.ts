...
export const getSingleAdminToDB = async (
  id: string
): Promise<IAdmin | null> => {
...
export const getAllAdminsToDB = async (
...
export const updateAdminToDB = async (
  id: string,
...
export const deleteAdminToDB = async (id: string): Promise<IAdmin | null> => {
